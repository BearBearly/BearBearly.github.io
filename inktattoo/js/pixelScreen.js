;$(function(){
    ...
    var pxs_url = 'img/inktattoo.jpg';
    var pxs_height = '10000px';
    var pxs_opacity_control = true;

//===============================================================================================================================================================================================================

    $('body').append('<div class="screen" style="opacity:0.5; background:url('+pxs_url+') no-repeat center top; position: absolute; left: 0; right: 0; top: 0; height: '+pxs_height+'; z-index: 999999; pointer-events: none; display: none;"></div>')
